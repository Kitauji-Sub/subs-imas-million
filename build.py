        ...
        for file in files:
            if file.endswith(".ass"):
                ...
                if os.name == 'nt':  # Windows
                    subprocess.run([f"{work_folder}/.github/steps/aegisub-cli.exe", "--automation", f"{work_folder}/.github/steps/automation/autoload/0x.KaraTemplater.moon", input_path, input_path, "0x539's Templater"])
                else:
